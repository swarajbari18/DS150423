...
import json
class ATM:
    with open(r'C:\Users\swaraj\Documents\DS150423\Python\_26_ATM_Project\customers.json') as file1:
    ...
    def storage(self):
        with open(f'C:/Users/swaraj/Documents/DS150423/Python/_26_ATM_Project/{self.pin_no}.txt', 'a+') as file3:
            file3.write(f'{self.customer[self.pin_no]}\n')

    def json_update(self):
        with open(r'C:\Users\swaraj\Documents\DS150423\Python\_26_ATM_Project\customers.json', 'w') as file2:
            json.dump((self.customer), file2)            

    def retrive_data(self):
        with open(f'C:/Users/swaraj/Documents/DS150423/Python/_26_ATM_Project/{self.pin_no}.txt', 'a+') as file4:
            file4.seek(0)       
            data = file4.read()
